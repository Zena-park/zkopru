export const DepositManagerABI = [
  {
    inputs: [
      { internalType: 'contract WTON', name: 'wton', type: 'address' },
      {
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'address', name: 'l2chain', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { internalType: 'address', name: 'layer2', type: 'address' },
      { internalType: 'bool', name: 'receiveTON', type: 'bool' },
    ],
    name: 'processRequest',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    payable: false,
  ...
  },
  {
    ...
    name: 'accStaked',
    outputs: [{ internalType: 'uint256', name: 'wtonAmount', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
