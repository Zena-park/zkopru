export const SeigManagerABI = [
  {
    inputs: [
      { internalType: 'contract ERC20Mintable', name: 'ton', type: 'address' },
      { internalType: 'contract ERC20Mintable', name: 'wton', type: 'address' },
      {
        internalType: 'contract Layer2RegistryI',
        name: 'registry',
        type: 'address',
      },
      {
        internalType: 'contract DepositManagerI',
        name: 'depositManager',
        type: 'address',
      },
      { internalType: 'uint256', name: 'seigPerBlock', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'factory',
    outputs: [
      { internalType: 'contract CoinageFactoryI', name: '', type: 'address' },
    ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'contract PowerTONI', name: 'powerton', type: 'address' },
    ],
    name: 'setPowerTON',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: 'bool', name: 'isCommissionRateNegative', type: 'bool' },
    ],
  ...
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: 'PseigRate_', type: 'uint256' }],
    name: 'setPseigRate',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'address', name: 'newSeigManager', type: 'address' },
      { internalType: 'address[]', name: 'coinages', type: 'address[]' },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'totAmount', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  {
    constant: false,
    inputs: [
      { internalType: 'uint256', name: 'adjustDelay_', type: 'uint256' },
    ],
    name: 'setAdjustDelay',
    outputs: [],
    payable: false,
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'uint256', name: 'minimumAmount_', type: 'uint256' },
    ],
