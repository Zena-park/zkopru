export const WatchLogicABI = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'kind', type: 'uint256' }],
    name: 'totalCountWatchers',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: 'kind', type: 'uint256' }],
    name: 'totalCountLayer2s',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'address', name: '_zkopru', type: 'address' }],
    name: 'isRegisteredZkopru',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_kind', type: 'uint256' },
    ],
    name: 'addWatcher',
    outputs: [],
    stateMutability: 'nonpayable',
