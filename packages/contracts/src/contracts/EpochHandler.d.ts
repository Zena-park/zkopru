...
export class EpochHandler extends Contract {
  ...
  methods: {
    ...
    prepareORE(): TransactionObject<void>

    prepareNRE(): TransactionObject<void>

    prepareOREAfterURE(): TransactionObject<void>

    prepareNREAfterURE(): TransactionObject<void>
  }
